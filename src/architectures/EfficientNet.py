...
Code written by: Thiago Sotoriva Lermen
    2021/06/30 Initital commit
"""
# expand ratio, num_channels, num_repeats, stride, kernel_size
base_model = [
        [1, 16, 1, 1, 3],
        [6, 24, 2, 2, 3],
        [6, 40, 2, 2, 5],
...
# compound scaling method Equation 3
# depth = alpha ** phi
# width = beta ** phi
...
class InvertedResidualBlock(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        if self.expand:
            self.expand_conv = CNNBlock(in_channels, hidden_dim,
    ...
    def create_features(self, width_factor, depth_factor, last_channels):
        ...
        for expand_ratio, channels, repeats, stride, kernel_size in base_model:
            ...
            for layer in range(layers_repeats):
                features.append(
                    InvertedResidualBlock(in_channels, out_channels,
